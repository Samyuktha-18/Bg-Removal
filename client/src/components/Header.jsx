  ...
  return (
    <div  className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
     ...
     <div>
        ...
        <p className='my-6 text-[15px] text-gray-500'>Transform your images effortlessly with our AI-powered background removal tool. 
            <br className='max-sm:hidden'/>Whether you’re preparing product photos, creating marketing materials, <br className='max-sm:hidden'/>
            or editing personal photos, we’ve got you covered.</p>
